...
Необходимо реализовать метод, который находит позицию последнего вхождения элемента x в массиве arr.
...
Необходимо реализовать метод, который вставляет элемент x в массив arr на позицию pos.
...
Необходимо реализовать метод, который разворачивает массив.
...
Необходимо реализовать метод, который объединяет два массива в один.
...
Необходимо реализовать метод, который удаляет все отрицательные элементы из массива.
